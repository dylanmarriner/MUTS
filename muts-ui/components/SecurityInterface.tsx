  ...
  return (
    <div className="p-6">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-bold text-workshop-100">Security</h1>
          <p className="text-workshop-500 mt-1">
            Manage ECU security access and authentication
          </p>
        </div>
        {isManufacturerMode && (
          <div className="flex items-center gap-2 px-3 py-1 bg-mazda-600/20 border border-mazda-600 rounded-lg">
            <Shield className="w-4 h-4 text-mazda-400" />
            <span className="text-sm text-mazda-400">Manufacturer Mode</span>
          </div>
        )}
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-1">
          <div className="card">
            <h2 className="text-lg font-semibold text-workshop-100 mb-4">Request Access</h2>
            
            {!ecu.connected ? (
              <div className="text-center py-8">
                <Lock className="w-8 h-8 text-workshop-600 mx-auto mb-2" />
